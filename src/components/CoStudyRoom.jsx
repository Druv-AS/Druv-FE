  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '720px', margin: '0 auto' }}>
      <div className="glass-card" style={{ padding: '32px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
        ...
        <div>
          <h2 style={{ fontSize: '1.4rem', fontFamily: 'var(--font-heading)', color: '#f3f4f6', fontWeight: 700 }}>
        ...
        {/* Live Presence Count */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#e5e7eb', fontSize: '1rem', fontWeight: 600 }}>
      ...
      <div className="glass-card" style={{ padding: '20px', display: 'flex', alignItems: 'center', gap: '14px' }}>
        ...
        <div style={{ fontSize: '0.85rem', color: '#d1d5db', lineHeight: 1.4 }}>
          <strong>Zero Distraction Protocol:</strong> No chat, no audio streams, no video camera feeds. Social facilitation is proven to stem purely from shared presence and synchronized time bounds.
        </div>
      </div>
    </div>
  );
